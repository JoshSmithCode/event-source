	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UpdateEditingRowKey':
				var index = msg.a;
				var newKey = msg.b;
				var _v2 = A2($elm$core$Array$get, index, model.editingUserData);
				if (_v2.$ === 'Nothing') {
					return model;
				} else {
					var _v3 = _v2.a;
			...
			case 'UpdateEditingRowValue':
				var index = msg.a;
				var newValue = msg.b;
				var _v4 = A2($elm$core$Array$get, index, model.editingUserData);
				if (_v4.$ === 'Nothing') {
					return model;
				} else {
					var _v5 = _v4.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('col-7 list-group mt-4')
							]),
						A2(
							$elm$core$List$cons,
							A2(
